...
export function Login({ onSwitchToSignup, onBackToLanding }: LoginProps) {
  ...
  const [userId, setUserId] = useState(""); // Store user_id for password reset
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.data) {
        // Store user_id from response if available
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // For password reset, the OTP code IS the otp_refer
      // No need to verify separately, just store it for reset password
      setOtpRefer(otp); // Use OTP code as otp_refer
      toast.success("OTP received! Please set your new password.");
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    if (!otpRefer) {
      setError("OTP reference is missing. Please verify OTP again.");
      return;
    }

    if (!userId) {
      setError("User ID is missing. Please try forgot password again.");
      return;
    }
                ...
                <g clipPath="url(#clip0_55_5566_login)">
                  <g filter="url(#filter0_dd_55_5566_login)">
                    <rect
                      ...
                      height="40"
                      rx="5"
                      fill="url(#paint0_linear_55_5566_login)"
                    />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                    ...
                    <path
                      ...
                      fill="url(#paint1_linear_55_5566_login)"
                    />
                  </g>
                </g>
                <defs>
                  <filter
                    id="filter0_dd_55_5566_login"
                    x="-12"
                    y="-2"
                    width="64"
                    height="64"
                  ...
                  >
                    ...
                    <feMorphology
                      ...
                      operator="erode"
                      in="SourceAlpha"
                      result="effect1_dropShadow_55_5566_login"
                    />
                    <feOffset dy="4" />
                    ...
                    <feMorphology
                      ...
                      operator="erode"
                      in="SourceAlpha"
                      result="effect2_dropShadow_55_5566_login"
                    />
                    <feOffset dy="10" />
                    ...
                    <feBlend
                      mode="normal"
                      in2="effect1_dropShadow_55_5566_login"
                      result="effect2_dropShadow_55_5566_login"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect2_dropShadow_55_5566_login"
                      result="shape"
                    />
                  </filter>
                  <linearGradient
                    id="paint0_linear_55_5566_login"
                    x1="0"
                    y1="0"
                    x2="40"
                    y2="40"
                  ...
                  <linearGradient
                    id="paint1_linear_55_5566_login"
                    x1="19.9993"
                    y1="27.4118"
                    x2="19.9993"
                    y2="31.9612"
                  ...
                  {showDemoOptions && (
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 animate-in fade-in slide-in-from-top-2 duration-300 mt-6">
                      ...
                      <Button
                        type="button"
                        variant="outline"
                        onClick={() => handleDemoLogin("lowbalance")}
                        disabled={isLoading}
                      ...
                      <Button
                        type="button"
                        variant="outline"
                        onClick={() => handleDemoLogin("zerobalance")}
                        disabled={isLoading}
              ...
              <>
                ...
                <div className="p-3 sm:p-4 rounded-lg bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 mt-6">
                  <p
                    className={`text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 ${fontClass}`}
                  >
                    💡 <strong>{t.auth.tip}</strong> {t.auth.forgotPasswordTip}
                  </p>
                </div>
              </>
            ) : view === "verifyOtp" ? (
