...
import { Key, BookOpen, DollarSign, ArrowRight, Globe } from 'lucide-react';
...
export const WelcomeScreen = memo(function WelcomeScreen({ userName, onGetStarted }: WelcomeScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-zinc-100 to-zinc-200 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl mx-auto">
        <Card className="p-6 sm:p-8 lg:p-10 bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 shadow-2xl max-w-md mx-auto relative">
          {/* Language Switcher */}
          <div className="absolute top-4 right-4 lg:top-6 lg:right-6 z-10">
            <Button
              ...
              className="flex items-center gap-2 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 p-2"
            >
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="mx-auto mb-4 w-12 h-12 sm:w-14 sm:h-14">
            ...
            <h1 className={`text-lg sm:text-xl lg:text-2xl text-zinc-900 dark:text-zinc-100 mb-2 ${fontClass}`}>
              {t.welcome.welcomeUser.replace('{userName}', userName)}
            </h1>
            <p className={`text-xs sm:text-sm lg:text-base text-zinc-600 dark:text-zinc-400 ${fontClass}`}>
              {t.welcome.accountCreated}
            </p>
          </div>

          {/* Free Credit Banner */}
          <div className="rounded-lg bg-gradient-to-br from-green-100 to-green-200 dark:from-green-950 dark:to-green-900 border border-green-300 dark:border-green-800 p-4 sm:p-5 mb-6 sm:mb-8">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white dark:bg-zinc-800 flex items-center justify-center flex-shrink-0">
                <span className="text-xl sm:text-2xl">🎁</span>
              </div>
              <div>
                <h3 className={`text-sm sm:text-base lg:text-lg text-green-900 dark:text-green-100 ${fontClass}`}>
                  {t.welcome.freeCreditTitle}
                </h3>
                <p className={`text-xs sm:text-sm text-green-700 dark:text-green-300 mt-0.5 ${fontClass}`}>
                  {t.welcome.freeCreditDesc}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 mb-6 sm:mb-8">
            <h3 className={`text-sm sm:text-base lg:text-lg text-zinc-900 dark:text-zinc-100 mb-3 sm:mb-4 ${fontClass}`}>
              {t.welcome.quickStartGuide}
            </h3>

            <Card className="p-3 sm:p-4 border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/50">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0">
                  <div className="w-5 h-5 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-en">
                    1
                  </div>
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <h4 className={`text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 ${fontClass}`}>{t.welcome.step1Title}</h4>
                  </div>
                  <p className={`text-xs text-zinc-600 dark:text-zinc-400 ${fontClass}`}>
                    {t.welcome.step1Desc}
                  </p>
                </div>
              </div>
            ...
            <Card className="p-3 sm:p-4 border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/50">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center flex-shrink-0">
                  <div className="w-5 h-5 rounded-full bg-purple-600 text-white flex items-center justify-center text-xs font-en">
                    2
                  </div>
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <h4 className={`text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 ${fontClass}`}>{t.welcome.step2Title}</h4>
                  </div>
                  <p className={`text-xs text-zinc-600 dark:text-zinc-400 ${fontClass}`}>
                    {t.welcome.step2Desc}
                  </p>
            ...
            <Card className="p-3 sm:p-4 border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/50">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-lg bg-green-100 dark:bg-green-900/30 flex items-center justify-center flex-shrink-0">
                  <div className="w-5 h-5 rounded-full bg-green-600 text-white flex items-center justify-center text-xs font-en">
                    3
                  </div>
                </div>
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-0.5">
                    ...
                    <h4 className={`text-xs sm:text-sm text-zinc-900 dark:text-zinc-100 ${fontClass}`}>{t.welcome.step3Title}</h4>
                  </div>
                  <p className={`text-xs text-zinc-600 dark:text-zinc-400 ${fontClass}`}>
                    {t.welcome.step3Desc}
                  </p>
          ...
          <div className="text-center">
            <Button
              ...
              size="default"
              className={`bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 text-white px-6 w-full sm:w-auto ${fontClass}`}
            >
              {t.welcome.getStarted}
              <ArrowRight className="w-4 h-4 ml-2" />
            </Button>
            <p className={`text-xs text-zinc-500 dark:text-zinc-500 mt-3 ${fontClass}`}>
              {t.welcome.needHelp}{' '}
              <a href="mailto:sales@roktenh.io" className="text-blue-600 dark:text-blue-400 hover:underline font-en">
                sales@roktenh.io
              </a>{' '}
              {t.welcome.orTelegram}{' '}
              <a href="https://t.me/RokTenh_Sales" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline font-en">
                @RokTenh_Sales
              </a>
            </p>
          </div>
