    ...
    <div className="space-y-6 mx-[0px] my-[0px] m-[0px]">
      ...
      <Card className="bg-white dark:bg-card border-zinc-200 dark:border-zinc-800 mt-[0px] mr-[0px] mb-[30px] ml-[0px] p-4 sm:p-6">
        ...
        <div className="space-y-4">
          <div>
            <p
              className={`text-sm text-zinc-700 dark:text-zinc-300 mb-2 ${fontClass}`}
            >
        ...
        <TabsList className="w-full justify-start overflow-x-auto">
          {categories.map((category) => (
            <TabsTrigger
              key={category}
              value={category}
              className={`capitalize cursor-pointer ${fontClass}`}
            >
          ...
          >
            {endpoints
              ...
              .map((endpoint, index) => (
                <Card
                  key={index}
                  className="sm:p-6 bg-white dark:bg-card border-zinc-200 dark:border-zinc-800 mt-[0px] mr-[0px] mb-[10px] ml-[0px] py-[20px] px-[24px]"
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <Badge
                        variant="outline"
                        className="bg-green-100 dark:bg-green-950/50 text-green-700 dark:text-green-400 border-green-300 dark:border-green-900/50 font-en"
                      >
                        {endpoint.method}
                      </Badge>
                      ...
                      <Badge
                        variant="outline"
                        className="bg-blue-100 dark:bg-blue-950/50 text-blue-700 dark:text-blue-400 border-blue-300 dark:border-blue-900/50 sm:ml-auto font-en"
                      >
                    ...
                    <div className="space-y-2">
                      <p
                        className={`text-sm text-zinc-700 dark:text-zinc-300 ${fontClass}`}
                      >
    ...
    // Response data here
      ...
      <Card className="p-4 sm:p-6 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-900/50">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3
              className={`text-sm text-blue-800 dark:text-blue-300 mb-1 ${fontClass}`}
            >
              {t.docs.needHelp}
            </h3>
            <p
              className={`text-sm text-blue-700 dark:text-blue-200 ${fontClass}`}
            >
              {t.docs.needHelpDesc}
            </p>
          </div>
