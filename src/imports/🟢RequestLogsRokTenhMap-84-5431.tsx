import svgPaths from "./svg-w1amh354pw";
import { img } from "./svg-ljdw8";
...
/**
 * @figmaAssetKey 4225479e8b2c696366ab95abc95def7a85dffe54
 */
...
/**
 * @figmaAssetKey b98c6d175cc333fd15304ad25e3427dd646055aa
 */
...
function Table() {
  return (
    <div className="h-[845px] relative rounded-[14px] shrink-0 w-full" data-name="Table">
      <div className="box-border content-stretch flex flex-col h-[845px] items-start overflow-x-clip overflow-y-auto p-px relative w-full">
        <TableRow1 className="bg-[#111111] h-[56px] shrink-0 sticky top-0 w-full" />
        <Frame1000006211 />
      </div>
