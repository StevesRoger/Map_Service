import svgPaths from "./svg-jnjgt07pcp";
import { img } from "./svg-6zoap";
        ...
        <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="payment logos">
          <div className="h-[20px] relative shrink-0 w-[34px]" data-name="Visa">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34 20">
              <g id="Visa">
                <path clipRule="evenodd" d={svgPaths.p367586c0} fill="var(--fill-0, #E1232E)" fillRule="evenodd" id="Fill 1" />
                <g id="Component 1 2 1">
                  <path d={svgPaths.pd8ec400} fill="var(--fill-0, white)" id="Path 5 1" />
                  <path d={svgPaths.p1b4c6400} fill="var(--fill-0, white)" id="Path 6 1" />
                  <path d={svgPaths.p699be00} fill="var(--fill-0, white)" id="Path 7 1" />
                  <path d={svgPaths.p3f8cfc00} fill="var(--fill-0, white)" id="Path 8 1" />
                  <g id="Group 3 1">
                    <path d={svgPaths.p22a5e000} fill="var(--fill-0, white)" id="Path 9 1" />
                    <path d={svgPaths.p3beba4f0} fill="var(--fill-0, white)" id="Path 10 1" />
                  </g>
                </g>
              </g>
            </svg>
...
/**
 * @figmaAssetKey da978b2f31088a31bf3e61c1ec76f67838cddfab
 */
function TableRow({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Table Row">
      ...
      <div className="flex flex-row items-center self-stretch">
        <div className="box-border content-stretch flex flex-col gap-[10px] h-full items-start px-[24px] py-[18px] relative shrink-0 w-[250px]" data-name="Table Cell">
          <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
            <div className="absolute left-0 size-[16px] top-[2px]" data-name="Icon">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                <g clipPath="url(#clip0_84_4406)" id="Icon">
                  <path d={svgPaths.p39ee6532} id="Vector" stroke="var(--stroke-0, #71717B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                  <path d="M8 4V8L10.6667 9.33333" id="Vector_2" stroke="var(--stroke-0, #71717B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                </g>
                <defs>
                  <clipPath id="clip0_84_4406">
                    <rect fill="white" height="16" width="16" />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[24px] not-italic text-[14px] text-nowrap text-zinc-100 top-[0.5px] tracking-[-0.1504px] whitespace-pre">11/4/2025, 10:23:50 AM</p>
          </div>
        </div>
      </div>
      <div className="basis-0 flex flex-row grow items-center self-stretch shrink-0">
        <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="Table Cell">
          <div className="size-full">
            <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[24px] py-[18px] relative size-full">
              <div className="bg-[rgba(24,24,27,0.5)] relative rounded-[10px] shrink-0 w-full" data-name="Container">
                <div aria-hidden="true" className="absolute border border-solid border-zinc-800 inset-0 pointer-events-none rounded-[10px]" />
                <div className="flex flex-row items-center size-full">
                  <div className="box-border content-stretch flex gap-[8px] items-center px-[13px] py-px relative w-full">
                    <div className="basis-0 grow h-[20px] min-h-px min-w-px relative shrink-0" data-name="Code">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] overflow-clip relative rounded-[inherit] w-full">
                        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[14px] text-nowrap text-zinc-300 top-[0.5px] whitespace-pre">mk_live_klm789nop012qrs345tuv678</p>
                      </div>
                    </div>
                    <div className="h-[32px] relative rounded-[8px] shrink-0 w-[36px]" data-name="Button">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[32px] items-center justify-center relative w-[36px]">
                        <div className="relative shrink-0 size-[16px]" data-name="Icon">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                            <g clipPath="url(#clip0_84_4417)" id="Icon">
                              <path d={svgPaths.p216f800} id="Vector" stroke="var(--stroke-0, #E4E4E7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                              <path d={svgPaths.p13e4b3c0} id="Vector_2" stroke="var(--stroke-0, #E4E4E7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                            </g>
                            <defs>
                              <clipPath id="clip0_84_4417">
                                <rect fill="white" height="16" width="16" />
                              </clipPath>
                            </defs>
                          </svg>
      ...
      <div className="basis-0 flex flex-row grow items-center self-stretch shrink-0">
        <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="Code">
          <div className="size-full">
            <div className="box-border content-stretch flex gap-[10px] items-start px-[24px] py-[18px] relative size-full">
              <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[16px] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-zinc-100">
      ...
      <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[24px] py-[17px] relative shrink-0 w-[130px]" data-name="Table Cell">
        <div className="relative rounded-[8px] shrink-0" data-name="Badge">
          <div className="box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[9px] py-[2px] relative rounded-[inherit]">
            <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[12px] text-nowrap text-zinc-200 whitespace-pre">GET</p>
          </div>
      ...
      <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[24px] py-[17px] relative shrink-0 w-[130px]" data-name="Table Cell">
        <div className="bg-[rgba(3,46,21,0.5)] relative rounded-[8px] shrink-0" data-name="Badge">
          <div className="box-border content-stretch flex gap-[10px] items-center justify-center overflow-clip px-[9px] py-[2px] relative rounded-[inherit]">
            <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#05df72] text-[12px] text-nowrap whitespace-pre">200</p>
          </div>
      ...
      <div className="box-border content-stretch flex flex-col gap-[10px] items-start px-[24px] py-[19px] relative shrink-0 w-[160px]" data-name="Table Cell">
        <div className="content-stretch flex gap-[10px] items-center justify-center relative shrink-0" data-name="Text">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#ff6467] text-[14px] tracking-[-0.1504px] w-[44px]">461ms</p>
        </div>
      </div>
      <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[12px] py-[17px] relative shrink-0" data-name="Table Cell">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#9f9fa9] text-[14px] text-nowrap tracking-[-0.1504px] whitespace-pre">72.181.74.137</p>
      </div>
      <div className="flex flex-row items-center self-stretch">
        <div className="box-border content-stretch flex gap-[10px] h-full items-center px-[20px] py-0 relative shrink-0 w-[120px]" data-name="Table Cell">
          <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#ff6467] text-[14px] tracking-[-0.1504px]">- $0.0001</p>
        </div>
      </div>
    </div>
  );
...
/**
 * @figmaAssetKey e1466a3931892a4850293dde42e52141a0fa2976
 */
function TableRow1({ className }: { className?: string }) {
  return (
    <div className={className} data-name="Table Row">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(159,159,169,0.1)] border-solid inset-0 pointer-events-none" />
      <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[20px] relative shrink-0 w-[250px]" data-name="Header Cell">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[#9f9fa9] text-[12px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">Timestamp</p>
      </div>
      <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Header Cell">
        <div className="flex flex-row items-center size-full">
          <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[20px] relative w-full">
            <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[#9f9fa9] text-[12px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">API Key Name</p>
          </div>
        </div>
      </div>
      <div className="basis-0 grow h-[56px] min-h-px min-w-px relative shrink-0" data-name="Header Cell">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[16px] left-[24px] not-italic text-[#9f9fa9] text-[12px] text-nowrap top-[21px] tracking-[0.6px] uppercase whitespace-pre">Endpoint</p>
      </div>
      <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[20px] relative shrink-0 w-[130px]" data-name="Header Cell">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[#9f9fa9] text-[12px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">Method</p>
      </div>
      <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[20px] relative shrink-0 w-[130px]" data-name="Header Cell">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[#9f9fa9] text-[12px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">Status</p>
      </div>
      <div className="box-border content-stretch flex gap-[10px] items-center px-[24px] py-[20px] relative shrink-0 w-[160px]" data-name="Header Cell">
        <p className="basis-0 font-['Inter:Bold',sans-serif] font-bold grow leading-[16px] min-h-px min-w-px not-italic relative shrink-0 text-[#9f9fa9] text-[12px] tracking-[0.6px] uppercase">Response Time</p>
      </div>
      <div className="box-border content-stretch flex gap-[10px] h-[56px] items-center px-[24px] py-0 relative shrink-0 w-[120px]" data-name="Header Cell">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[#9f9fa9] text-[12px] text-nowrap tracking-[0.6px] uppercase whitespace-pre">IP Address</p>
      </div>
      <div className="box-border content-stretch flex gap-[10px] h-[56px] items-center px-[20px] py-0 relative shrink-0 w-[120px]" data-name="Header Cell">
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[#9f9fa9] text-[12px] text-nowrap text-right tracking-[0.6px] uppercase whitespace-pre">Cost</p>
      </div>
    </div>
  );
}
...
function Icon5() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_84_4421)" id="Icon">
          <path d={svgPaths.p2e329c00} id="Vector" stroke="var(--stroke-0, #51A2FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p17412500} id="Vector_2" stroke="var(--stroke-0, #51A2FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M5 5H5.00833" id="Vector_3" stroke="var(--stroke-0, #51A2FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M5 15H5.00833" id="Vector_4" stroke="var(--stroke-0, #51A2FF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
          <clipPath id="clip0_84_4421">
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[94.025px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[94.025px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#51a2ff] text-[16px] text-nowrap top-[-2.2px] whitespace-pre">Request Logs</p>
      </div>
    </div>
  );
}
...
function Icon9() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Icon">
          <path d={svgPaths.pb1f2000} id="Vector" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p3427e900} id="Vector_2" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p11bd83d8} id="Vector_3" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p1d1b2740} id="Vector_4" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M14.0433 14.81L13.7242 15.58" id="Vector_5" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p37711d00} id="Vector_6" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M16.275 15.58L15.9567 14.81" id="Vector_7" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M17.31 11.5433L18.08 11.2242" id="Vector_8" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M17.31 13.4567L18.08 13.7758" id="Vector_9" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p31b7b00} id="Vector_10" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={svgPaths.p2c4f400} id="Vector_11" stroke="var(--stroke-0, #9F9FA9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[130.213px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[130.213px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#9f9fa9] text-[16px] text-nowrap top-[-2.2px] whitespace-pre">User Management</p>
      </div>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="h-[32px] relative shrink-0 w-[197px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[32px] left-0 not-italic text-[24px] text-nowrap text-white top-0 tracking-[0.0703px] whitespace-pre">$80.28</p>
    </div>
  );
}
...
function Button9() {
  return (
    <div className="bg-[#1b5ba5] h-[32px] relative rounded-[8px] shrink-0 w-[197px]" data-name="Button">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[58.16px] not-italic text-[14px] text-nowrap text-white top-[6.5px] tracking-[-0.1504px] whitespace-pre">Top-up Now</p>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="h-[20px] relative shrink-0 w-[128.461px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[128.461px]">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#9f9fa9] text-[14px] text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">{`Close & Open Menu`}</p>
      </div>
    </div>
  );
}
...
function Button10() {
  return (
    <div className="content-stretch flex gap-[8px] h-[40px] items-center justify-center relative rounded-[10px] shrink-0 w-full" data-name="Button">
      <Icon10 />
      <Text10 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Navigation">
      <div className="flex flex-col items-center justify-end size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-center justify-end p-[16px] relative w-full">
          <Button10 />
        </div>
      </div>
    </div>
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24px] left-0 not-italic text-[16px] text-nowrap text-zinc-100 top-[-0.5px] tracking-[-0.3125px] whitespace-pre">Request Logs</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#9f9fa9] text-[14px] text-nowrap top-[0.5px] tracking-[-0.1504px] whitespace-pre">Monitor API requests in real-time</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="h-[48px] relative shrink-0 w-[212.023px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[4px] h-[48px] items-start relative w-[212.023px]">
        <Heading2 />
        <Paragraph1 />
      </div>
    </div>
...
function Container11() {
  return (
    <div className="bg-zinc-950 box-border content-stretch flex h-[40px] items-center px-[12px] py-[4px] relative rounded-[8px] shrink-0 w-[256px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.8px] border-solid border-zinc-800 inset-0 pointer-events-none rounded-[8px]" />
      <Input />
    </div>
  );
}
...
function Container12() {
  return (
    <div className="bg-zinc-950 box-border content-stretch flex h-[40px] items-center px-[12px] py-[4px] relative rounded-[8px] shrink-0 w-[152px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[0.8px] border-solid border-zinc-800 inset-0 pointer-events-none rounded-[8px]" />
      <Icon12 />
      <PrimitiveButton />
    </div>
...
function Frame1000006210() {
  return (
    <div className="h-full relative shrink-0 w-[825.188px]">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[20px] h-full items-center justify-end relative w-[825.188px]">
        <Container11 />
        <Container12 />
      </div>
    </div>
...
function TableBody() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[1452px]" data-name="Table Body">
      <TableRow className="content-stretch flex items-center relative shrink-0 w-[1452px]" />
    </div>
  );
}
...
function Code3() {
  return (
    <div className="basis-0 grow h-full min-h-px min-w-px relative shrink-0" data-name="Code">
      <div className="size-full">
        <div className="box-border content-stretch flex gap-[10px] items-start px-[24px] py-[18px] relative size-full">
          <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[16px] min-h-px min-w-px not-italic relative shrink-0 text-[12px] text-zinc-100">{`/api/v1/maps/tiles/{z}/{x}/{y}`}</p>
        </div>
      </div>
    </div>
  );
...
function TableBody1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[1452px]" data-name="Table Body">
      <div className="content-stretch flex items-center relative shrink-0 w-[1452px]" data-name="Table Row">
        <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-solid border-zinc-800 inset-0 pointer-events-none" />
        <div className="flex flex-row items-center self-stretch">
          <TableCell7 />
        </div>
...
function Frame1000006211() {
  return (
    <div className="h-[788px] relative shrink-0">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[788px] items-start overflow-x-clip overflow-y-auto relative">
        <TableBody />
...
function Table() {
  return (
    <div className="bg-zinc-900 h-[845px] relative rounded-[14px] shrink-0 w-full" data-name="Table">
      <div className="box-border content-stretch flex flex-col h-[845px] items-start overflow-x-clip overflow-y-auto p-px relative w-full">
        <TableRow1 className="h-[56px] shrink-0 sticky top-0 w-full" />
        <Frame1000006211 />
      </div>
...
function RequestLogs() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[917px] items-start relative shrink-0 w-full" data-name="RequestLogs">
      <Container13 />
      <Table />
    </div>
  );
...
function AdminDashboard() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px relative shrink-0 w-full" data-name="AdminDashboard">
      <RequestLogs />
    </div>
  );
}
...
function MainContent() {
  return (
    <div className="bg-black h-full relative shrink-0 w-[1494.4px]" data-name="Main Content">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[20px] h-full items-start overflow-clip p-[20px] relative rounded-[inherit] w-[1494.4px]">
        <AdminDashboard />
...
function AppContent1() {
  return (
    <div className="basis-0 bg-[#0a0a0f] content-stretch flex gap-[4.578e_-5px] grow items-start min-h-px min-w-px relative shrink-0 w-full" data-name="AppContent">
      <div className="bg-zinc-900 h-full relative shrink-0 w-[256px]" data-name="Sidebar">
...
export default function RequestLogsRokTenhMap() {
  return (
    <div className="bg-[#0a0a0f] content-stretch flex flex-col items-start relative size-full" data-name="🟢 Request Logs -RokTenh Map">
